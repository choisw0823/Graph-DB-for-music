...
class MIDI:
    def __init__(self, name):
        ...
        try:
            ...
            print('Error Occured during midiAnalyze.py __init__() : ', e) 
    ...
    def openMidi(self, midi_path, remove_drums):
        try:
            ...
            print('Error Occured during midiAnalyze.py openMidi() : ', e) 
            return None
    ...
    def instrument(self):
        try:
            ...
            print('Error Occured during midiAnalyze.py instrument() : ', e)
            return None
    #return key
    def key(self):
        try:
            ...
            print('Error Occured during midiAnalyze.py key() : ', e) 
            return None
    ...
    def tempo(self):
        midi_file = converter.parse(self.path)
    ...
    def extractChords(self):
        try:
            ...
            print('Error Occured during midiAnalyze.py extrachords() : ', e) 
            return None
    ...
    def noteCount(self, measure, count_dict):
        try:
            ...
            print('Error Occured during midiAnalyze.py noteCount() : ', e) 
            return None
    ...
    def simplifyRomanName(self, roman_numeral):
        ...
        # Checking valid inversions.
            ...
            print('Error Occured during midiAnalyze.py simplifyRomanName() : ', e) 
            return None
